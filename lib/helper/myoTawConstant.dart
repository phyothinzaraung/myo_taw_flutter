...
class myColor{
  static final Color colorPrimary = Color(0xff08c299);
  static final Color colorPrimaryDark = Color(0xff06b48e);
  static final Color colorTextGrey = Color(0xff9ea3a8);
...
class myString{
  static final String txt_like = "နှစ်သက်";
  static final String txt_save = "သိမ်းမည်";
}
...
class ApplyBizLicenseScreen extends StatefulWidget {
  BizLicenseModel model;
  ApplyBizLicenseScreen(this.model);
  @override
  _ApplyBizLicenseScreenState createState() => _ApplyBizLicenseScreenState(this.model);
}

class _ApplyBizLicenseScreenState extends State<ApplyBizLicenseScreen> {
  ...
  _ApplyBizLicenseScreenState(this._bizLicenseModel);
